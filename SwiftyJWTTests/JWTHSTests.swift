...
class JWTHSTests: XCTestCase {
    ...
    func testGenerateJWTSignedWithHS() {
        ...
        */
        ...
        XCTAssertEqual(jwtWithKeyId.rawString, "eyJhbGciOiJIUzI1NiIsImtpZCI6InRlc3RLZXlJZCIsInR5cCI6IkpXVCJ9.eyJoZWlnaHQiOjEyMS41LCJhZ2UiOjEyNSwic3ViIjoic2h1byIsImlzQWRtaW4iOnRydWUsImV4cCI6NTE1NjE2MTg3OTkzLCJuYW1lIjoid2FuZyIsImlzcyI6Inl1ZnUifQ.ahoJ3T64Vd2DJvQh6ux2CnXplzb1QyIUTTjuYb17Obg")
    }

    func testVerifyTokenSignedWithHS256() throws {
